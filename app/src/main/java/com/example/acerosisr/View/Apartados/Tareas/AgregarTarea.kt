...
@Composable
fun AgregarTareaScreen(navController: Navigation, tareasViewModel: TareasViewModel) { // Added TareasViewModel
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("Empleado Asignado (ID o Nombre)") },
                modifier = Modifier.fillMaxWidth()
            )
            Spacer(modifier = Modifier.height(16.dp))

            Button(onClick = { /* TODO: Save logic -> Call tareasViewModel.createTask(...) */ }, modifier = Modifier.fillMaxWidth(),
